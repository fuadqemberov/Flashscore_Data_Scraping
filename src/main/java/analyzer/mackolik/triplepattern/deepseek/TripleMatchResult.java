...
public class TripleMatchResult {
    public String homeTeam1;
    public String awayTeam1;
    public String score1;
    public String htScore1;

    public String homeTeam2;
    public String awayTeam2;
    public String score2;
    public String htScore2;

    public String homeTeam3;
    public String awayTeam3;
    public String score3;
    public String htScore3;

    public String previousMatchScore;
    public String previousHTScore;
    public String nextMatchScore;
    public String nextHTScore;
    public String season;

    public ThreeMatchPattern originalPattern;
