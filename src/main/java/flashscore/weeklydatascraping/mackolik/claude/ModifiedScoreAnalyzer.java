...
public class ModifiedScoreAnalyzer {
    ...
    public static class MatchResult {
        ...
        public static void findScorePattern(MatchPattern pattern, String year, int id, WebDriver driver2) {
            try {
                // No need to get all teams since we're checking for exact matches
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            for (int year = 2023; year >= 2021; year--) {
                ...
                MatchResult.findScorePattern(currentPattern, years, 195, driver);
            }
