...
public class DatePickerAutomationClaude {
    ...
    private static final int MAX_THREADS = Math.max(1, Runtime.getRuntime().availableProcessors() - 1); // Leave one core free
...
//        }
        ...
        for (int j = 1; j < 3; j++) {
            ...
            for (int i = 3; i < 7; i++) {
                try {
                    ...
                    WebElement homeElement = wait.until(x -> driver.findElement(By.xpath(xpathHome)));
                    WebElement scoreElement = wait.until(x -> driver.findElement(By.xpath(xpathScore)));
                    WebElement awayElement = wait.until(x -> driver.findElement(By.xpath(xpathAway)));
    ...
    public static String extractFormattedScore(String url, WebDriver driver) {
        ...
        try {
            ...
            WebElement homeScoreElement = wait.until(x ->
                    x.findElement(By.cssSelector(".p0c-soccer-match-details-header__score-home")));
            ...
            try {
                WebElement detailedScoreElement = driver.findElement(
                        By.className("p0c-soccer-match-details-header__detailed-score"));
                ...
                // If detailed score is not found, just use full time score
    ...
    private static void getMatchesByDateRange(WebDriver driver, LocalDate startDate, LocalDate endDate)
        ...
        Thread.sleep(3000); // Give extra time for initial page load
        ...
        try {
            ...
            while (!currentDate.isAfter(endDate)) {
                ...
                try {
                    ...
                    // Select year/month view with retry
                    for (int attempt = 1; attempt <= MAX_RETRIES; attempt++) {
                        try {
