...
public class NowgoalLastMatchesOptimizedFinal3 {
    ...
    public static void main(String[] args) {
        ...
        // WebDriver havuzu oluşturuluyor
        ...
        // İşlenecek maç ID aralığı
        long startId = 2607246;
        long endId = 2607474;
        ...
        // İlerleme takibi için ayrı thread
        executor.submit(() -> {
    ...
    private static void processMatch(WebDriver driver, long matchId) {
        try {
            ...
            // Home takım maçlarının yüklenmesini bekle
            wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//tr[starts-with(@id, 'tr1_')]")));

            // Sayfa kaynağı alınır ve Jsoup ile parse edilir
    ...
    // GELİŞTİRİLMİŞ clickElement metodu: Elemente normal veya JS ile tıklama
    private static void clickElement(WebDriver driver, By locator) {
        try {
            ...
            Thread.sleep(200); // Tıklama sonrası kısa bekleme
        } catch (Exception e) {
            System.err.println("Click error: " + e.getMessage());
        }
    }

    public static List<String> extractMatchData(Document doc, String rowPrefix) {
    ...
    public static String extractResult(Document doc) {
    ...
    public static String extractLeague(Document doc) {
    ...
    public static void writeMatchesToExcel(List<List<String>> data) {
